    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600">
                <p>
                    Lorsque l'authentification à deux facteurs est activée, vous serez invité à saisir un jeton sécurisé
                    et aléatoire lors de l'authentification. Vous pouvez récupérer ce jeton depuis l'application Google
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p v-if="confirming" class="font-semibold">
                            ...
                            à l'aide de l'application d'authentification de votre téléphone ou saisissez la clé de
                            configuration et fournissez le code OTP généré.
                        </p>

                        <p v-else>
                            L'authentification à deux facteurs est désormais activée. Numérisez le code QR suivant à
                            l'aide de l'application d'authentification de votre téléphone ou saisissez la clé de
                            configuration.
                        </p>
                    </div>
                    ...
                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            Clé de
                            configuration: <span v-html="setupKey"></span>
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            Conservez ces codes de récupération dans un gestionnaire de mots de passe sécurisé. Ils
            ...
            <div class="mt-5">
                ...
                <div v-else>
                    ...
                    <ConfirmsPassword @confirmed="showRecoveryCodes">
                        <SecondaryButton v-if="recoveryCodes.length === 0 && !confirming" class="me-3">
                            Affichez les codes de récupération.
                        </SecondaryButton>
                    </ConfirmsPassword>
