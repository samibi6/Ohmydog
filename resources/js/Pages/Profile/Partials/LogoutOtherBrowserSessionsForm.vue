    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si nécessaire, vous pouvez vous déconnecter de toutes vos autres sessions de navigateur sur tous vos
                appareils. Certaines de vos sessions récentes sont répertoriées ci-dessous; cependant, cette liste peut
                ne pas être exhaustive. Si vous pensez que votre compte a été compromis, vous devriez également mettre à
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-if="session.is_current_device" class="text-green-500 font-semibold">Cet
                                    appareil</span>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Veuillez entrer votre mot de passe pour confirmer que vous souhaitez vous déconnecter de vos autres
                    sessions de navigateur sur tous vos appareils.
