...
<template>
    ...
    <AuthenticationCard>
        ...
        <div>
            <h1 class="text-4xl text-center mb-4">Inscription</h1>
        </div>
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <TextInput id="prenom" v-model="form.prenom" type="text" class="mt-1 block w-full" required autofocus
                    autocomplete="prenom" />
            ...
            <div class="mt-4">
                <InputLabel for="tel" value="Numéro de téléphone" />
                <TextInput id="tel" v-model="form.tel" type="tel" class="mt-1 block w-full" required
                    autocomplete="tel" />
